...
`<div>
    ...
    <div>
        ...
        수정</router-link>
        <button v-on:click="deleteData">삭제</button> <!-- 삭제는 이벤트를 통해 처리 -->
    </div>  
</div>`
        ...
        deleteData : function(no){
            const vueObject =this;
             ...
             $.ajax({
                 ...
                 url : 'http://192.168.0.2:8081/myserver/empDelete', //필수
                 type : 'post',
                 data : { employee_id : vueObject.empId }, // data는 무조건 object 형태로
                 dataType : 'json',
                 success : function(data){
                     if(data != null){
